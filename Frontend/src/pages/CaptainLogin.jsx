            ...
            <div className='p-7 h-screen flex flex-col justify-between'>
                <div>
                    <form onSubmit={submitHandler}>
                        ...
                        <p className='text-center'>New Driver? <Link to={'/captain-signup'} className='text-blue-600'>Create an Account as Captain</Link></p>
                    </form>
                </div>
                <div>
                    <Link to={'/user-login'}>
                        <button
                            className='bg-[#e7b84a] text-white font-semibold mb-5 rounded px-4 py-2 w-full text-lg placeholder:text-base '
                        >Sign in as User
                        </button>
                    </Link>
                </div>
